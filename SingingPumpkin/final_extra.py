    ...
    while (True):
        ...
        if (first_finger==1 and second_finger==0 and third_finger==0 and fourth_finger==0):
            ...
            if (counter_tracking1 >10):
                ...
                #screen_on()
                #print("Hi")
                Path = '/home/pumpkin2/Music/final/final_1.mp4'
            ...
            if (counter_tracking2> 10):
                song=2
                #screen_on()
                Path = '/home/pumpkin2/Music/final/final_2.mp4'
                pumpkin_on(Path, song)
                first_song=0
                second_song=0
                third_song=0
            ...
            if (counter_tracking3>10):
                song=3
                #screen_on()
                Path = '/home/pumpkin2/Music/final/final_3.mp4'
                pumpkin_on(Path, song)
                first_song=0
                second_song=0
                third_song=0
            ...
            if (counter_tracking4>10):
                song=4
                #screen_on()
                Path = '/home/pumpkin2/Music/final/final_4.mp4'
                pumpkin_on(Path, song)
                first_song=0
                second_song=0
                third_song=0
            ...
            if (counter_tracking5>10):
                song=5
                #screen_on()
                Path = '/home/pumpkin2/Music/final/final_5.mp4'
                pumpkin_on(Path, song)
                first_song=0
                second_song=0
                third_song=0
